...
def CTCLoss(actual, prediction):
    ...
    loss = keras.backend.ctc_batch_cost(actual, prediction, input_len, label_len)
    return loss
...
def build_model(input_dim, output_dim, rnn_layers=5, rnn_units=128):
    ...
    output = layers.Dense(units=output_dim + 1, activation="softmax", name="dense_output")(x)  # Renamed to "dense_output"
